...
// v3 adds resumable attention without changing the v1 execution terminal.
// The driver can therefore opt into v3 while proof finalization remains v1.
...
export async function startPeer(opts) {
  ...
  if (activationBinding.activationAttemptId && !runnerInstanceId) {
    throw new Error('runner_instance_id_required_for_activation');
  }
